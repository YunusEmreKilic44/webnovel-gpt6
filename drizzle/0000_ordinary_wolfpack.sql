...
ALTER TABLE "applications" ADD CONSTRAINT "applications_book_id_books_id_fk" FOREIGN KEY ("book_id") REFERENCES "public"."books"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "applications" ADD CONSTRAINT "applications_reviewer_id_user_id_fk" FOREIGN KEY ("reviewer_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "books" ADD CONSTRAINT "books_author_id_user_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "library_entries" ADD CONSTRAINT "library_entries_book_id_books_id_fk" FOREIGN KEY ("book_id") REFERENCES "public"."books"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "one_pending_application_idx" ON "applications" USING btree ("book_id","type") WHERE "applications"."status" = 'PENDING';--> statement-breakpoint
CREATE INDEX "books_catalog_idx" ON "books" USING btree ("status","hidden","updated_at");--> statement-breakpoint
CREATE UNIQUE INDEX "revision_version_idx" ON "chapter_revisions" USING btree ("chapter_id","version");--> statement-breakpoint
CREATE UNIQUE INDEX "chapters_position_idx" ON "chapters" USING btree ("volume_id","position");--> statement-breakpoint
CREATE INDEX "chapters_book_idx" ON "chapters" USING btree ("book_id","status");--> statement-breakpoint
CREATE UNIQUE INDEX "library_user_book_idx" ON "library_entries" USING btree ("user_id","book_id");--> statement-breakpoint
CREATE UNIQUE INDEX "rating_user_book_idx" ON "ratings" USING btree ("user_id","book_id");--> statement-breakpoint
