...
export const auditLabels: Record<string, string> = {
  ...
  ADMIN_COIN_PACKAGE_SAVED: "Coin paketi kaydedildi",
  ADMIN_PREMIUM_RULES_UPDATED: "Premium başvuru şartları değişti",
  "chapter.access_changed": "Bölüm erişimi değişti",
  "book.updated": "Kitap bilgileri güncellendi",
